  ...
  <div class="page-container">
    ...
    <section class="hero-section">
      <div class="hero-content" 
        ...
        <h1 class="page-title">Paysagiste</h1>
        <p class="page-subtitle">Aménageons ensemble vos espaces extérieurs.</p>
      </div>
    </section>
    ...
    <section class="text-image-section">
      <div class="container" v-scroll-reveal>
        <div class="text-left" data-aos="fade-right" data-aos-duration="1500" :data-aos-delay="isMobile ? 600 : index * 0">
          <h2 class="section-title" >Concevez le jardin de vos rêves</h2>
          <p class="section-text">Transformez vos espaces extérieurs en véritables havres de paix grâce à nos experts paysagistes. De la création de jardins uniques à l’aménagement de terrasses, nous mettons en œuvre vos idées avec créativité et précision. Chaque projet est personnalisé.</p>
        </div>
        <div class="image-right" data-aos="fade-left" data-aos-duration="1500">
          <img src="@/assets/petite_cour_apres.jpg" alt="Jardin personnalisé" />
        </div>
      </div>
    </section>
    ...
    <section class="image-text-section" >
      <div class="container">
        <div class="image-left" :data-aos="isMobile ? 'fade-left' : 'fade-right'" data-aos-duration="1500">
          <img src="@/assets/allee1_apres.jpg" alt="Paysagiste au travail" />
        </div>
        <div class="text-right" :data-aos="isMobile ? 'fade-right' : 'fade-left'" data-aos-duration="1500">
          <h2 class="section-title">L’Art de Sublimer Vos Espaces</h2>
          <p class="section-text">Nos paysagistes professionnels conçoivent des jardins et aménage extérieurs qui allient esthétique, fonctionnalité et durabilité. Nous créons des espaces sur mesure, mêlant végétaux, matériaux et designs adaptés à vos envies. Faites de votre extérieur.</p>
        </div>
      </div>
    </section>
  ...
  data() {
    return {
      carouselImages: [
        ...
        require('@/assets/allee1_apres.jpg'),
        require('@/assets/petite_cour_apres.jpg')
      ],
...
.hero-section {
  position: relative;
  background-image: url('@/assets/creationRigole_apres.jpg'); /* Image de fond */
